...
public class AuditarMovieEstado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Auditar Movie Estado");
        ...
        btnAuditar.setBackground(new java.awt.Color(153, 153, 0));
        btnAuditar.setFont(new java.awt.Font("Tahoma", 3, 18)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AuditarMovieEstado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AuditarMovieEstado().setVisible(true);
            }
        });
    }
